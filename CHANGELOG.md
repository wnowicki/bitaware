...
- `explain` to replace previous `__str__` functionality

### Fixed

- `__str__` for Pydantic `model_bump()`
...
[Unreleased]: https://github.com/wnowicki/bitaware/compare/0.2.0...HEAD
[0.2.0]: https://github.com/wnowicki/bitaware/compare/0.1.1...0.2.0
